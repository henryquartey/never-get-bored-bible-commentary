...
const PRECACHE = [
  ...
  './data/commentary.js', './data/refined.js', './data/dict.js', './data/apikeys.js'
];
/* Files that change often — always try the network first, fall back to cache offline. */
const FRESH = /\/(index\.html|manifest\.webmanifest|data\/(apikeys|refined|chronological|dict|books|versions|audio_kjv|audio_kokoro)\.js|data\/commentary\.json)$/;
