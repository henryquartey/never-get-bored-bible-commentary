...
const FRESH = /\/(index\.html|manifest\.webmanifest|data\/(withdrawn|apikeys|refined|chronological|dict|books|versions|audio_kjv|audio_kokoro)\.js|data\/commentary\.json)$/;
